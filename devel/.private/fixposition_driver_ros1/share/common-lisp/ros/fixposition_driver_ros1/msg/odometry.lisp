...
(cl:defmethod cl:initialize-instance :after ((m <odometry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'odometry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fixposition_driver_ros1-msg:<odometry> is deprecated: use fixposition_driver_ros1-msg:odometry instead.")))
...
(cl:defmethod pose_frame-val ((m <odometry>))
...
(cl:defmethod kin_frame-val ((m <odometry>))
...
(cl:defmethod acceleration-val ((m <odometry>))
...
(cl:defmethod fusion_status-val ((m <odometry>))
...
(cl:defmethod imu_bias_status-val ((m <odometry>))
...
(cl:defmethod gnss1_status-val ((m <odometry>))
...
(cl:defmethod gnss2_status-val ((m <odometry>))
...
(cl:defmethod wheelspeed_status-val ((m <odometry>))
...
(cl:defmethod version-val ((m <odometry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fixposition_driver_ros1-msg:version-val is deprecated.  Use fixposition_driver_ros1-msg:version instead.")
  (version m))
