// Generated by gencpp from file fixposition_driver_ros1/odometry.msg
// DO NOT EDIT!


#ifndef FIXPOSITION_DRIVER_ROS1_MESSAGE_ODOMETRY_H
#define FIXPOSITION_DRIVER_ROS1_MESSAGE_ODOMETRY_H
...
struct odometry_
{
  ...
  typedef boost::shared_ptr< ::fixposition_driver_ros1::odometry_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::fixposition_driver_ros1::odometry_<ContainerAllocator> const> ConstPtr;

}; // struct odometry_

typedef ::fixposition_driver_ros1::odometry_<std::allocator<void> > odometry;

typedef boost::shared_ptr< ::fixposition_driver_ros1::odometry > odometryPtr;
typedef boost::shared_ptr< ::fixposition_driver_ros1::odometry const> odometryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::fixposition_driver_ros1::odometry_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::fixposition_driver_ros1::odometry_<ContainerAllocator1> & lhs, const ::fixposition_driver_ros1::odometry_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::fixposition_driver_ros1::odometry_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::fixposition_driver_ros1::odometry_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::fixposition_driver_ros1::odometry_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
{
  ...
  static const char* value(const ::fixposition_driver_ros1::odometry_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x22d6d51108a2fea4ULL;
  static const uint64_t static_value2 = 0xa6df4142dddad933ULL;
};

template<class ContainerAllocator>
struct DataType< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
{
  static const char* value()
  {
    return "####################################################################################################\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::fixposition_driver_ros1::odometry_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::fixposition_driver_ros1::odometry_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // FIXPOSITION_DRIVER_ROS1_MESSAGE_ODOMETRY_H
