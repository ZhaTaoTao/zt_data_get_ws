...
"""autogenerated by genpy from fixposition_driver_ros1/gpgst.msg. Do not edit."""
import codecs
import sys
...
class gpgst(genpy.Message):
  _md5sum = "3488fe86af0a80e28c42198845ea643a"
  _type = "fixposition_driver_ros1/gpgst"
...
"""
  __slots__ = ['time','rms_range','std_major','std_minor','angle_major','std_lat','std_lon','std_alt']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time,rms_range,std_major,std_minor,angle_major,std_lat,std_lon,std_alt
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7d().pack(_x.rms_range, _x.std_major, _x.std_minor, _x.angle_major, _x.std_lat, _x.std_lon, _x.std_alt))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.rms_range, _x.std_major, _x.std_minor, _x.angle_major, _x.std_lat, _x.std_lon, _x.std_alt,) = _get_struct_7d().unpack(str[start:end])
      return self
