...
"""autogenerated by genpy from fixposition_driver_ros1/llh.msg. Do not edit."""
import codecs
import sys
...
class llh(genpy.Message):
  _md5sum = "8e7bbdcafaeb2f9efbe4b2cb41c30f25"
  _type = "fixposition_driver_ros1/llh"
...
float64 y
float64 z"""
  __slots__ = ['header','pose_frame','position','covariance']
  _slot_types = ['std_msgs/Header','string','geometry_msgs/Vector3','float64[9]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose_frame,position,covariance
