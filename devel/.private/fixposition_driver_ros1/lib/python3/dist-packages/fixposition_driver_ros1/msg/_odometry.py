...
"""autogenerated by genpy from fixposition_driver_ros1/odometry.msg. Do not edit."""
import codecs
import sys
...
class odometry(genpy.Message):
  _md5sum = "22d6d51108a2fea4a6df4142dddad933"
  _type = "fixposition_driver_ros1/odometry"
...
float64 y
float64 z"""
  __slots__ = ['header','pose_frame','kin_frame','pose','velocity','acceleration','fusion_status','imu_bias_status','gnss1_status','gnss2_status','wheelspeed_status','version']
  _slot_types = ['std_msgs/Header','string','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance','geometry_msgs/Vector3','int16','int16','int16','int16','int16','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose_frame,kin_frame,pose,velocity,acceleration,fusion_status,imu_bias_status,gnss1_status,gnss2_status,wheelspeed_status,version
